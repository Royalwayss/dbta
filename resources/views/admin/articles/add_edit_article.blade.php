          ...
          <div class="card-body">
            <div class="row">
              <div class="col-12">
                ...
                @if($prevId!=0)
                  <a href="{{ url('admin/add-edit-article/'.$prevId) }}" class="btn btn-primary btn-animated-link"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp;Previous Article</a>
                @endif
                @if($nextId!=0)
                  <a href="{{ url('admin/add-edit-article/'.$nextId) }}" class="btn btn-primary btn-animated-link"> Next Article  <i class="fas fa-arrow-right"></i> </a>
                @endif
                </div>
                </div>
                @if ($errors->any())
                ...
                @endif
                <form name="categoryForm" id="categoryForm" action="{{ url('admin/add-edit-article') }}" method="post" enctype="multipart/form-data">@csrf
                @if(!empty($row['id']))
                ...
                <div class="card-body">
				  ...
				  <div class="form-group col-md-6">
                   ...
                   <div class="form-group col-md-6">
					...
					@if(!empty($row['pdf']))
					<a target="_block" href="{{ asset('front/pdf/articles/'.$row['pdf']) }}">View Pdf</a>
				   @endif
                  </div>
