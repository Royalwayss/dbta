...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="{{url('admin/dashboard')}}" class="brand-link" style="background-color:#fff; border:0px !important;">
    <img src="{{ asset('front/assets/images/dtba-logo.png') }}"  class="brand-image" style="width:120px; height:auto; max-height:100% !important; border:0px !important;">
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		...
		<li class="nav-item">
          <a href="{{ url('admin/meetings') }}" class="nav-link {{ $active }}">
            <i class="nav-icon fas fa-th"></i>
            <p>
              Mettings
            </p>
		...
		@if(Session::get('page')=="newsletters")
            @php $active="active" @endphp
        @else
            @php $active = "" @endphp
        @endif
		...
		<li class="nav-item">
          <a href="{{ url('admin/newsletters') }}" class="nav-link {{ $active }}">
            <i class="nav-icon fas fa-th"></i>
            <p>
              Newsletters
            </p>
		...
		<li class="nav-item">
          <a href="{{ url('admin/downloads') }}" class="nav-link {{ $active }}">
            <i class="nav-icon fas fa-th"></i>
            <p>
              Downloads
            </p>
		...
		<li class="nav-item">
          <a href="{{ url('admin/media') }}" class="nav-link {{ $active }}">
            <i class="nav-icon fas fa-th"></i>
            <p>
              Media
            </p>
		...
		@if(Session::get('page')=="home-media")
            @php $active="active" @endphp
        @else
            @php $active = "" @endphp
        @endif
		...
		<li class="nav-item">
          <a href="{{ url('admin/home-media') }}" class="nav-link {{ $active }}">
            <i class="nav-icon fas fa-th"></i>
            <p>
              Home Media 
            </p>
		...
		@if(Session::get('page')=="committees")
            @php $active="active" @endphp
        @else
            @php $active = "" @endphp
        @endif
		...
		<li class="nav-item">
          <a href="{{ url('admin/committees') }}" class="nav-link {{ $active }}">
            <i class="nav-icon fas fa-th"></i>
            <p>
              Committees
            </p>
		...
		<li class="nav-item">
          <a href="{{ url('admin/case-laws') }}" class="nav-link {{ $active }}">
            <i class="nav-icon fas fa-th"></i>
            <p>
              Case Laws
            </p>
		...
		<li class="nav-item">
          <a href="{{ url('admin/executive-body') }}" class="nav-link {{ $active }}">
            <i class="nav-icon fas fa-th"></i>
            <p>
              Executive Body
            </p>
