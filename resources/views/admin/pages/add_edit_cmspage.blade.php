...
<style>
    ...
    .ck.ck-editor__main>.ck-editor__editable:not(.ck-hover) {
        border-color: var(--ck-color-base-border);
              ...
              <div class="col-12">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <textarea style="background-color:#ccc !important;" class="form-control" rows="3" id="editor" name="description" placeholder="Enter Description">@if(!empty($cmspage['description'])) {{ $cmspage['description'] }} @endif</textarea>
                  </div>
                  <div class="form-group col-md-12">
