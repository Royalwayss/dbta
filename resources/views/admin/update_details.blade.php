            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
                  @if(Session::has('error_message'))
                    ...
                    @endforeach
              <!-- form start -->
              <form method="post" action="{{ url('admin/update-details/request') }}" enctype="multipart/form-data">@csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="mobile" id="mobile" placeholder="Mobile" value="{{ Auth::guard('admin')->user()->mobile }}">
                  </div>
                  <div class="form-group">
