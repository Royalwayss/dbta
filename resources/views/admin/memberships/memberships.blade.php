...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Memberships Management</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
              ...
              <div class="card-body">
                <table id="users" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td ><a @if($row['view_status'] == 0) style="color:red" @else style="color:green" @endif href="{{ asset('admin/view-membership/'.$row['id']) }}"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
                  </tr>
                  @endforeach
                  </tbody> 
                </table>
