        ...
        <center style="width: 100%; background-color: #f1f1f1;">
            ...
            <div style="max-width: 600px; margin: 0 auto; width: 100%; background-color: #fff;" class="email-container">
                ...
                <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                                ...
                                <tr>
                                    <td style="width: 100%;">
                                        <div class="text" style="padding: 0 2.5em; text-align: center;">
                                            <h2 style="width: 100%; float: left; display: inline-block; text-align: center; margin-bottom: 20px;">Product Back in Stock</h2>
                                            <p style="float: left; width: 100%; text-align: center; color: #acacac; margin-bottom: 0;">Dear <span>Customer</span>,<br />Good news! The product you were waiting for is now back in stock. Don’t miss out—grab it before it’s gone again!</p>
                    ...
                    <tr>
                        <td valign="middle" class="hero hero-2 bg_white" style="padding: 0 0 0 0;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td style="width: 100%;">
                                        <div class="text" style="padding: 0 0; text-align: center;">
                                            <h3 style="width: 100%; float: left; display: inline-block; text-align: center; margin-bottom: 20px;">Product Details:</h3>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 50%">
                                        <p style="float: left; width: 100%; text-align: right; line-height: 1; color: #acacac; margin-bottom: 0; line-height: 1 padding: 0">
                                            <span style="color: #acacac"> {{ $product_name }} </span>
                                        </p>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td class="bg_white" style="padding: 5px 25px; width: 100%;">
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    ...
                                    <td style="width: 50%">
                                        <p style="float: left; width: 100%; text-align: right; line-height: 1; color: #acacac; margin-bottom: 0; line-height: 1 padding: 0">
                                            <span style="color: #acacac"> {{ $product_size }} </span>
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td class="bg_white" style="padding: 10px 25px 10px; width: 100%; border-top: 1px solid #ddd;">
                            <p style="float: left; width: 100%; text-align: center; line-height: 1.575; color: #acacac; margin-bottom: 0; line-height: 1 padding: 0"><br>
                                <a href="{{$notify_product_link}}" style="color: #000; text-decoration:underline;">Click here to Buy Now</a>
                            </p>
