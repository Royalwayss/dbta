    ...
    <body>
        ...
        <table width='80%' border='0' cellpadding='3' cellspacing='3' style='border:#EFEFEF 5px solid; padding:5px;'>
			...
			<tr>
                ...
                <td class='style2'>Hey {{ $data['name'] }},</td>

            </tr>
            <tr>

                <td class='style2'>Thanks for registering with {{ $websettings['site_name'] }}.</td>

            </tr>
			 <tr>

                <td class='style2'>Your account information is as below :-</td>
