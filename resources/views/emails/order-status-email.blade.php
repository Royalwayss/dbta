            ...
            <tr>
                <td height='70' align='right' valign='top'>
                    <table width='93%' border='0' align='right' cellpadding='3' cellspacing='0' >
                        ...
                        <tr>
                            <td align='left' valign='top' class='style3'>Hi {{ $orderDetails['getuser']['name'] }},</td>
                        </tr>
                        <tr>
                            <td align='left' valign='top' class='style3'>&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            <td align='left' valign='top' class='style3'>Your order status has been updated to {{ $order_status }}</td>
                        </tr>
                        <tr>
                            <td align='left' valign='top' class='style3'>&nbsp;</td>
                        </tr>
                       ...
                       @if(!empty($comments))
					    <tr>
                            <td align='left' valign='top' class='style3'>Comments: {{ $comments }}</td>
                        </tr>
                        <tr>
                            <td align='left' valign='top' class='style3'>&nbsp;</td>
                        </tr>
                       ...
                       <tr>
                            <td align='left' valign='top' class='style3'>Order Details are as below:</td>
                        </tr>
                       <tr>
                            <td align='left' valign='top' class='style3'>&nbsp;</td>
                        </tr>
