                                ...
                                <tr>
                                    <td style="width: 100%;">
                                        <div class="text" style="padding: 0 2.5em; text-align: center;">
                                            <h2 style="width: 100%; float: left; display: inline-block; text-align: center; margin-bottom: 20px;">RETURN {{ strtoupper($return_status) }}</h2>
                                            <p style="float: left; width: 100%; text-align: center; color: #acacac; margin-bottom: 0;">Hey <span>{{ $name }}</span>,<br />Your order #{{ $returnDetails['order_id'] }} return status for product {{ $product_code }} has been {{ $return_status }}.</p>
                                        </div>
                                    </td>
                                </tr>
                            </table>
