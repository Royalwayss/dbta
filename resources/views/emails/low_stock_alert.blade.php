                                ...
                                <tr>
                                    <td style="width: 100%;">
                                        <div class="text" style="padding: 0 2.5em; text-align: center;">
                                            <h2 style="width: 100%; float: left; display: inline-block; text-align: center; margin-bottom: 20px;">⚠️ Low Stock Alert</h2>
                                            <p style="float: left; width: 100%; text-align: center; color: #acacac; margin-bottom: 0;">Hey <span>Admin</span>,<br />This is to inform you that the stock for the following product has dropped to a critical level:</p>
                                ...
                                <tr>
                                    <td style="width: 100%;">
                                        <div class="text" style="padding: 0 0; text-align: center;">
                                            <h2 style="width: 100%; float: left; display: inline-block; text-align: center; margin-bottom: 20px;">Product Details:</h2>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 50%">
                                        <p style="float: left; width: 100%; text-align: right; line-height: 1; color: #acacac; margin-bottom: 0; line-height: 1 padding: 0">
                                            <span style="color: #acacac"> {{ $sku }} </span>
                                        </p>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td class="bg_white" style="padding: 5px 25px; width: 100%;">
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    ...
                                    <td style="width: 50%">
                                        <p style="float: left; width: 100%; text-align: right; line-height: 1; color: #acacac; margin-bottom: 0; line-height: 1 padding: 0">
                                            <span style="color: #acacac"> {{ $stock }} </span>
                                        </p>
                                    </td>
                                </tr>
                            </table>
