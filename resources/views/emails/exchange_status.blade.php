        ...
        <center style="width: 100%; background-color: #f1f1f1;">
            ...
            <div style="max-width: 600px; margin: 0 auto; width: 100%; background-color: #fff;" class="email-container">
                ...
                <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td class="logo" style="text-align: center;">
                                        <a href="{{ url(config('constants.project_url'))}}" target="_blank" href="" style="width: 100%; float: left; text-align: center; display: inline-block;">
                                        <img src="{{ asset(config('constants.project_url').'front/images/logo-scrolled.png') }}" alt="" style="width: 120px; display: inline-block; float: none;"><br><br>
                                        </a>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td style="width: 100%;">
                                        <div class="text" style="padding: 0 2.5em; text-align: center;">
                                            <h2 style="width: 100%; float: left; display: inline-block; text-align: center; margin-bottom: 20px;">EXCHANGE {{ strtoupper($exchange_status) }}</h2>
                                            <p style="float: left; width: 100%; text-align: center; color: #acacac; margin-bottom: 0;">Hey <span>{{ $name }}</span>,<br />Your order #{{ $exchangeDetails['order_id'] }} exchange status for product {{ $product_code }} has been {{ $exchange_status }}.</p>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td valign="middle" class="hero hero-2 bg_white" style="padding: 0 0 2em 0;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td style="width: 100%;">
                                        <h3 style="width: 100%; float: left; display: inline-block; text-align: center; margin-bottom: 8px; font-weight: 500; line-height: 1;">Current Size - {{$exchangeDetails['current_size']}}</h3>
                                        <h3 style="width: 100%; float: left; display: inline-block; text-align: center; margin-bottom: 8px; font-weight: 500; line-height: 1;">Requested Size - {{$exchangeDetails['requested_size']}}</h3>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td class="bg_white" style="padding: 10px 25px 10px; width: 100%; border-top: 1px solid #ddd;">
                            <p style="float: left; width: 100%; text-align: center; line-height: 1.575; color: #acacac; margin-bottom: 0; line-height: 1 padding: 0">
                                Please keep this email for future reference & don't forget to add us to your favorites to make it easier to come back and view our latest product range and offers.
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td class="bg_white" style="padding: 10px 25px 10px; width: 100%; border-top: 1px solid #ddd;">
                            <p style="float: left; width: 100%; text-align: center; line-height: 1.575; color: #acacac; margin-bottom: 0; line-height: 1 padding: 0">
                                If you need any help you can<br /> drop us an email: <a href="{{config('constants.project_email')}}" style="color: #000;">{{config('constants.project_email')}}</a>
                            </p>
                            <p style="float: left; width: 100%; text-align: center; line-height: 1.575; color: #acacac; margin-bottom: 0; line-height: 1 padding: 0">Team {{config('constants.project_name')}}</p>
                        </td>
                    </tr>
                </table>
            </div>
