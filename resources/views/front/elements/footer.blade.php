	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-12">
				<h3 class="footer_heading_three heading_three footer_text">District Taxation Bar Association – A Voice for
			...
			<?php /*<div class="col-lg-4 col-md-6 col-12">
				<div class="linkWrap">
					<h5>Our Policies</h5>
					<ul>
						<li><a target="_blank" href="javascript::void()">Privacy policy</a></li>
						<li><a target="_blank" href="javascript::void()">Terms & Conditions</a></li>
