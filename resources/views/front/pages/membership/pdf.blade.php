...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* ── TOP NAME + PHOTO ROW ── */
  .top-table { width: 100%; border-collapse: collapse; margin-bottom: 6px; }
  ...
  .row-table td { vertical-align: bottom; padding: 0 6px 0 0; }
  .row-table td:last-child { padding-right: 0; }

  /* ── PROFESSIONAL ── */
  .prof-row { margin-bottom: 6px; }
  .prof-inline { display: inline; }
  .checkbox-wrap {
  ...
  .tick-note { font-size: 9px; color: #555; font-style: italic; }

  /* ── KYC ── */
  .kyc-aadhaar { width: 100%; border-collapse: collapse; margin-bottom: 8px; }
  .kyc-aadhaar td { vertical-align: bottom; padding: 0 6px 0 0; width: 50%; }
  .kyc-aadhaar td:last-child { padding-right: 0; }

  .kyc-list-table { width: 100%; border-collapse: collapse; margin-bottom: 8px; }
  .kyc-list-table td { vertical-align: bottom; padding: 2px 4px 2px 0; width: 50%; }
  .kyc-item-row { display: flex; align-items: flex-end; gap: 4px; }
  .kyc-num { font-weight: bold; color: #1a2b5e; font-size: 11px; white-space: nowrap; }
  .kyc-text { font-size: 10.5px; white-space: nowrap; }
  ...
  /* ── SIGNATURE ── */
  .sig-area { text-align: right; padding: 0 20px 12px; }
  ...
  /* ── OFFICE USE ── */
  .office-section { padding: 0 20px 16px; }
  .office-scrutiny { font-size: 11px; font-weight: bold; color: #1a2b5e; margin-bottom: 2px; }
  .office-sub { font-size: 10px; color: #666; margin-bottom: 6px; }

  .office-rec-table { width: 100%; border-collapse: collapse; margin-bottom: 8px; }
  .office-rec-table td { font-size: 11px; width: 50%; padding: 2px 0; }

  .sign-boxes-table { width: 100%; border-collapse: collapse; margin-top: 8px; }
  .sign-boxes-table td { width: 50%; padding: 0 6px 0 0; }
  .sign-boxes-table td:last-child { padding: 0; }
  .sign-box {
    border: 1px solid #9aa3bc;
    text-align: center;
  ...
  .mem-date-table { width: 100%; border-collapse: collapse; margin-top: 10px; }
  .mem-date-table td { width: 50%; vertical-align: bottom; padding: 0 10px 0 0; }
  .mem-date-table td:last-child { padding: 0; }
  .mem-label { font-size: 10.5px; font-weight: bold; color: #1a2b5e; margin-bottom: 2px; }
...
<div class="page">
    ...
    <table class="top-table">
      <tr>
        ...
        <td style="width:108px; padding-left:12px; vertical-align:top;">
          ...
          <div class="photo-caption">Affix Passport Size Photograph</div>
        </td>
      </tr>
    </table>
  ...
  <div class="office-section">
    ...
    <table class="sign-boxes-table">
      <tr>
        <td><div class="sign-box">(SECRETARY)</div></td>
        <td><div class="sign-box">(PRESIDENT)</div></td>
      </tr>
    </table>
